...
namespace IndianaBones
{
    ...
    public class MuroAngoloInAltoDx : MonoBehaviour
    {
        int x;
        int y;
        ...
        void Start()
        {
            ...
            muro.sprite = Resources.Load("muroAngoloInAltoDx", typeof(Sprite)) as Sprite;
            this.transform.position = new Vector2(x, y);
			elementi.scacchiera[x, y].name = "Muro_AngoloAltoDx";
