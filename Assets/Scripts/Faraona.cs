...
namespace IndianaBones
{
    ...
    public class Faraona : Character
    {
        ...
        {     
            ...
            audioFaraona = GetComponent<AudioSource>();
        ...
        IEnumerator UpdateHealthBar()
        {
            ...
            healthBar.transform.GetChild(4).GetChild(0).GetComponent<Image>().sprite = Resources.Load("EnemyIcons/Head_Faraona", typeof(Sprite)) as Sprite;
        ...
        IEnumerator AttaccoADistanza()
        {
            ...
            uovo = Instantiate(uovoLancio);
            uovo.transform.position = this.transform.position;
		...
		IEnumerator HandleDeath(){
            ...
            audioFaraona.Stop();
            audioFaraona.clip = AudioContainer.Self.SFX_Faraona_Death;
            audioFaraona.Play();
